...
# На УР.4 после годноты идёт бонус-раунд «сбей сгустки» (main._logic9_bonus).
# ============================================================
...
class VexMech extends NpcMech:
	...
	func _liquid_area(g) -> Rect2:
		...
		# границы берём У САМОГО СТАКАНА (у Векса это всегда прямой стакан)
...
# иначе — только стикер. Порт special:'no_timer'. Сосуд-часы не портирован:
# нужна пара картинок стекла и маска налива, кодом их не нарисовать.
# ============================================================
