...
const FOCUS_META := {
	"bubbles": {"icon": "🫧", "name": "сгустки",
		"desc": "Сгустки оценивают строго, остальное — мягче. Награда выше."},
	"color":   {"icon": "🎨", "name": "спектр",
		"desc": "Спектр оценивают строго, остальное — мягче. Награда выше."},
	"size":    {"icon": "📏", "name": "габариты",
		"desc": "Габариты оценивают строго, остальное — мягче. Награда выше."},
}
