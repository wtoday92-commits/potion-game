...
# Верх арт-стойки (bg_for_game_table) на экране: UV 0.606 * 1280 ≈ 776. Банку
# сажаем на этот АБСОЛЮТНЫЙ экранный Y, а не в долях своей области (иначе не
# совпадёт с артом). Ручка для подгонки по скрину.
const TABLE_SCREEN_Y := 776.0
